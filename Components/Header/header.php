...
<header class="floe-site-header">
	<div class="floe-site-brand">
		<?php if ( has_custom_logo() ) : ?>
			<?php the_custom_logo(); ?>
		<?php else : ?>
			<a class="floe-site-logo" href="<?php echo esc_url( home_url( '/' ) ); ?>"><img src="<?php echo esc_url( get_template_directory_uri() . '/Assets/Brand/floe-logo.svg' ); ?>" width="208" height="64" alt="<?php echo esc_attr( get_bloginfo( 'name' ) ); ?>"></a>
		<?php endif; ?>
	</div>
