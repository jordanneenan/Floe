 ...
 * row with the year in the site's timezone and the light/dark toggle.
 *
...
function footer( array $args = array() ): string {
	...
	return sprintf(
		...
		. '<div class="site-footer__bottom"><p>%5$s</p><div class="site-footer__meta"><p>%6$s</p>%7$s</div></div>'
		. '</div></footer>',
		...
		\Floe\component( 'theme-toggle', array( 'class' => 'site-footer__theme' ) )
	);
}
