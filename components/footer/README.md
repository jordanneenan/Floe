...
- **Legal row:** "© <year> <site name>." (year in the site's timezone) followed by the legal line from Appearance → Customize → Footer (default "All rights reserved."), and "Built with Floe".
