...
| Field | Notes |
| --- | --- |
| Eyebrow, Heading, Intro | Stacked heading group (Body intro). |
| Form slot | Your mailing provider's block or a Shortcode block. A single email field and submit button sit on one line; the button matches the 52px field. |
